...
一、工作回顾与业绩达成
本人主要负责 AppServer（应用服务器）的开发工作。包括标准版、企业版、轻量版、SpringBoot版的各个版本的应用服务器的需求开发、Bug修复、现场问题处理等。以及相关依赖插件的研发工作。开发需求 12 个。修复 BUG 96个



一、 工作态度与纪律
在工作态度与纪律方面，我严格遵守公司考勤制度及各项管理规定，工作认真踏实、积极主动，服从领导安排。
